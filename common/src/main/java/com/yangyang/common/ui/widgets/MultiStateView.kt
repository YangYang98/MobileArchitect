package com.yangyang.common.ui.widgets
...
constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) :
     ...
     */
    private var stateBeforeChangeListener: ((oldState: ViewState, newState: ViewState) -> Boolean)? = null
     ...
     * 根据enum直接定位到内部数组的索引
     */
    private val views = Array<View?>(ViewState.entries.size) { null }
    ...
    init {
        //初始化 配置的布局
        context.withStyledAttributes(attrs, R.styleable.MultiStateView) {
            ...
            enableAnimateLayoutChanges =
                getBoolean(R.styleable.MultiStateView_msv_enableAnimateChanges, false)
